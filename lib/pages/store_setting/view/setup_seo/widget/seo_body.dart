            ...
            return FixedBottom(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    Text(translate('auth:text_store_seo_setup'), style: theme.textTheme.titleLarge),
                    ...
                    Text(translate('auth:text_facebook_setup'), style: theme.textTheme.titleLarge),
                    const SizedBox(height: 20),
                    FaceBookTitleWidget(),
                    const SizedBox(height: 15),
                    FaceBookDesWidget(),
                    ...
                    const FacebookImage(),
                    const SizedBox(height: 40),
                    Text(translate('auth:text_twitter_setup'), style: theme.textTheme.titleLarge),
                    const SizedBox(height: 20),
                    TwitterTitleWidget(),
                    const SizedBox(height: 15),
                    TwitterDesWidget(),
