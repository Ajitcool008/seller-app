              ...
              Expanded(
                child: ViewReport(
                  ...
                  titleNumber: (state.reportStats?.data?.month?.grossSales != null)
                      ...
                      : " ",
                  percent: (currentRoleIsAdmin(context)) ? null : getPercentGross(state.reportStats),
              ...
              Expanded(
                child: ViewReport(
                  ...
                  titleNumber: (state.reportStats?.data?.month?.totalEarn != null)
                      ...
                      : " ",
                  percent: (currentRoleIsAdmin(context)) ? null : getPercentEarn(state.reportStats),
                  symbolNumber: currency_format.getSymbol(state.reportStats?.currency ?? "USD"),
