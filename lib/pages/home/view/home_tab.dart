...
import 'chart_anlytic_admin.dart';
import 'chart_sales_admin.dart';
                    ...
                    Column(
                      children: [
                        ...
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            (currentRoleIsAdmin(context))
                                ? ChartSalesAdminHome(key: UniqueKey())
                            ...
                            (currentRoleIsAdmin(context))
                                ? ChartAnalyticAdmin(key: UniqueKey())
