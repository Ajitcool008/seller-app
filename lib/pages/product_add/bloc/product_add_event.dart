...
class AddFieldAddOns extends ProductAddEvent {
  const AddFieldAddOns();
}

class UpdateFieldAddOnsAt extends ProductAddEvent {
  final ProductAddOnModel productAddOnModel;
  final int index;
  const UpdateFieldAddOnsAt(this.productAddOnModel, this.index);
}

class RemoveFieldAddOnsAt extends ProductAddEvent {
  final int index;
  const RemoveFieldAddOnsAt(this.index);
}

class UpdateAddOnsStorage extends ProductAddEvent {
  final int? index;
  final ProductAddOnModel? productAddOnModel;
  final List<ProductAddOnModel>? listProductAddOnModel;
  const UpdateAddOnsStorage({
    this.index,
    this.productAddOnModel,
    this.listProductAddOnModel
  });
}

class SaveAddOns extends ProductAddEvent {
  const SaveAddOns();
}
