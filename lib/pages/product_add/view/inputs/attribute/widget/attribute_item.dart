    ...
    return VariableContainer(
      children: [
        ExpansionView(
          ...
          children: [
            ListTile(
              title: Text(translate('product:text_visit_product'), style: theme.textTheme.bodyMedium),
            ...
            if (showVariation) ...[
              ...
              ListTile(
                title: Text(translate('product:text_use_variation'), style: theme.textTheme.bodyMedium),
                contentPadding: EdgeInsets.zero,
                leading: CupertinoSwitch(
