...
class Price extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ThemeData theme = Theme.of(context);
    TextStyle styleSale = (theme.textTheme.bodyMedium ?? const TextStyle()).copyWith(color: theme.colorScheme.error);
    TextStyle? styleRegular = theme.textTheme.bodyMedium;
    return Html(
      ...
      style: {
        ...
        'del': Style.fromTextStyle(
            styleRegular!.copyWith(decoration: TextDecoration.lineThrough, color: theme.textTheme.bodySmall?.color)),
