                        ...
                        child: OrderChartView(
                          ...
                          chart: Column(
                            children: [
                                  ...
                                  child: LineChart(
                                    LineChartData(
                                      ...
                                      titlesData: LineTitle.getTitleData(
                                        ...
                                        isYearMonthFormat: (state.filterChartOption == FilterChartOption.year && currentRoleIsAdmin(context)),
                                      ),
                                        ...
                                        LineChartBarData(
                                            ...
                                            belowBarData: BarAreaData(
                                                ...
                                                colors: ColorBlock.listChartColor[3]
                                                    ...
                                                    .toList())),
                                        //withdrawal
                                        if(!currentRoleIsAdmin(context)) LineChartBarData(
                              ...
                              buildLegendChartOrder(translate, isAdmin: currentRoleIsAdmin(context)),
                            ],
                          ),
