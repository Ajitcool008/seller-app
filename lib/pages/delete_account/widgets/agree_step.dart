                        ...
                        children: [
                          InkResponse(
                            ...
                            child: Icon(
                              ...
                              color: state.isAgree ? theme.primaryColor : theme.textTheme.bodySmall?.color,
                              size: 22,
                            ),
                          ),
                          ...
                          Flexible(
                            child: Text(
                              ...
                              style: theme.textTheme.bodySmall?.copyWith(
                                color: state.isAgree ? theme.textTheme.titleMedium?.color : null,
                                fontWeight: state.isAgree ? theme.textTheme.titleMedium?.fontWeight : null,
                              ),
                            ),
                          ),
                        ],
