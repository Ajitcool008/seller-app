...
class _ResendState extends State<_Resend> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> result = [
      Text(translate('auth:text_resend_code_in', {'time': '$_start'}), style: theme.textTheme.bodySmall),
    ];

    if (_start == 0) {
      result = [
        Text(translate('auth:text_get_otp'), style: theme.textTheme.bodySmall),
        TextButton(
          onPressed: () async {
          ...
          style: TextButton.styleFrom(
            ...
            textStyle: theme.textTheme.labelLarge?.copyWith(fontSize: theme.textTheme.bodySmall?.fontSize),
          ),
