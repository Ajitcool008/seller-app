...
class _ReStoreAbleDatePickerEntryMode extends RestorableValue<DatePickerEntryMode> {
  _ReStoreAbleDatePickerEntryMode(
...
Future<DateTimeRange?> showDateRangePickers({
...
class _DateRangePickerDialogState extends State<DateRangePickerDialog> with RestorationMixin {
  late final _ReStoreAbleDatePickerEntryMode _entryMode = _ReStoreAbleDatePickerEntryMode(widget.initialEntryMode);
    ...
    switch (_entryMode.value) {
      ...
      case DatePickerEntryMode.calendarOnly:
        contents = _CalendarRangePickerDialog(
          ...
          onReset: _hasSelectedDateRange ? _handleReset : null,
...
class _CalendarRangePickerDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextTheme textTheme = theme.textTheme;
    final Color headerForeground = colorScheme.brightness == Brightness.light ? Colors.blue : colorScheme.onSurface;
    ...
    final TextStyle saveButtonStyle = (textTheme.labelLarge ?? const TextStyle()).apply(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: <Widget>[
            ...
            // TextButton(
            //   onPressed: onReset,
            //   child: Text("ĐẶT LẠI", style: saveButtonStyle),
            // ),
