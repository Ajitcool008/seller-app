...
Product _$ProductFromJson(Map<String, dynamic> json) => Product(
      ...
      totalSales: Product._toInt(json['total_sales']),
      ...
      weight: ConvertData.stringToDoubleCanBeNull(json['weight']),
      dimensions:
          json['dimensions'] == null ? null : ProductDimensions.fromJson(json['dimensions'] as Map<String, dynamic>),
