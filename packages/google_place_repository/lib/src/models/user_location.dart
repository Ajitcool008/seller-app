...
class UserLocation {
  ...
  UserLocation({this.id, this.lat, this.lng, this.address, this.tag, this.defaultLocation});
  ...
  @override
  String toString() {
    return '{"id": "$id", "lat": $lat, "lng": $lng, "address": "$address", "tag": "$tag","defaultLocation":$defaultLocation}';
  }
}
