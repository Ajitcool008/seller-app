...
import '../../wordpress_repository.dart';
...
class Post {
  ...
  static String _imageFromJson(dynamic value) =>
      value == null || value == false || value == "" ? "https://cdn.rnlab.io/placeholder-416x416.png" : value as String;
...
class PostBlocks {
  ...
  static const String advencedCustomFields = 'AdvancedCustomFields';
}
