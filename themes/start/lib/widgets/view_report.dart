        ...
        children: [
          WidgetSpan(
            ...
            child: Text(
              ...
              style: theme.textTheme.titleLarge?.copyWith(fontSize: 14, color: colorNumber),
            ),
          ),
          TextSpan(text: titleNumber),
        ],
        style: theme.textTheme.titleLarge?.copyWith(color: colorNumber),
      ),
      child: Row(
        children: [
          Text(
  ...
  Widget buildPercent(ThemeData theme) {
    if (percent != null) {
      ...
      return Row(
        ...
        children: [
          Text(text, style: theme.textTheme.labelSmall?.copyWith(color: colorPercent)),
          Icon(
            iconPercent,
            size: 12,
            color: colorPercent,
