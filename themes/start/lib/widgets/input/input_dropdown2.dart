...
class InputDropdown2 extends StatelessWidget {
  ...
  Widget buildValue(ThemeData theme) {
    TextStyle? style =
        isSmall ? theme.textTheme.bodyMedium : theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w500);
    return Text(
      value?.name ?? '',
      style: style,
      maxLines: 1,
  ...
  Widget buildIcon(ThemeData theme) {
    Color? color = isOutline == false ? null : theme.textTheme.bodySmall?.color;
