...
class _ChatMessagesState extends State<ChatMessages> {
  ...
  Widget build(BuildContext context) {
    ...
    ChatTheme chatTheme = DefaultChatTheme(
      ...
      sentMessageCaptionTextStyle: (theme.textTheme.titleSmall ?? const TextStyle()).copyWith(color: Colors.white),
      sentMessageBodyTextStyle: (theme.textTheme.bodyMedium ?? const TextStyle()).copyWith(color: Colors.white),
      sentMessageLinkTitleTextStyle: (theme.textTheme.titleMedium ?? const TextStyle()).copyWith(color: Colors.white),
      sentMessageLinkDescriptionTextStyle:
          (theme.textTheme.bodyMedium ?? const TextStyle()).copyWith(color: Colors.white),
      receivedMessageBodyTextStyle:
          (theme.textTheme.bodyMedium ?? const TextStyle()).copyWith(color: theme.textTheme.titleMedium?.color),
