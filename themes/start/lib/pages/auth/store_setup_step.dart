    ...
    return Padding(
      ...
      child: Row(
        children: List.generate(items.length, (index) {
          ...
          Color? textColor = selected ? theme.primaryColor : theme.textTheme.bodySmall?.color;
...
class _DividerLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color? borderColor = selected ? theme.primaryColor : theme.textTheme.bodySmall?.color;
    return Row(
      children: [
        if (visit != 'start')
          Expanded(
