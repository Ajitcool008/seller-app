...
InputDecorationTheme _buildInputDecorationTheme({
  ...
  return base.copyWith(
    ...
    errorStyle: textTheme.labelSmall?.copyWith(color: errorColor),
    errorMaxLines: 5,
  );
}
...
TextTheme _buildTextTheme(TextTheme base, String fontFamily, Color color, Color secondColor, Color thirdColor) {
  return base.copyWith(
    displayLarge:
        base.displayLarge?.copyWith(fontFamily: fontFamily, fontSize: 96, fontWeight: FontWeight.w500, color: color),
    displayMedium:
        base.displayMedium?.copyWith(fontFamily: fontFamily, fontSize: 60, fontWeight: FontWeight.w500, color: color),
    displaySmall:
        base.displaySmall?.copyWith(fontFamily: fontFamily, fontSize: 48, fontWeight: FontWeight.w500, color: color),
    headlineMedium:
        base.headlineMedium?.copyWith(fontFamily: fontFamily, fontSize: 34, fontWeight: FontWeight.w500, color: color),
...
ThemeData getCustomThemeData({Brightness? brightness}) {
  ...
  return base.copyWith(
    ...
    snackBarTheme: SnackBarThemeData(
      ...
      contentTextStyle: textTheme.bodyMedium?.copyWith(color: colorTheme.snackBarColor),
