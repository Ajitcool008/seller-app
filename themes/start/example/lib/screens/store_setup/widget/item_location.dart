import 'package:example/extension/strings.dart';
import 'package:example/mixins/utility_mixin.dart';
              ...
              children: [
                Padding(
                  ...
                  child: Icon(
                    ...
                    size: 16,
                    color: primaryIcon ? theme.primaryColor : theme.textTheme.bodySmall?.color,
                  ),
                ),
