    ...
    return Scaffold(
      body: FixedBottom(
        bottom: StoreSetupBottom(
          textButtonSecondary: "Not Now",
          textButtonPrimary: "Let go",
        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Text("Welcome to Store Manager", style: theme.textTheme.titleLarge),
                const SizedBox(height: 25),
                Text(
                  "Thank you for choosing Store Manager! This quick setup wizard will help you to configure the basic settings and you will have your store ready in no time.",
