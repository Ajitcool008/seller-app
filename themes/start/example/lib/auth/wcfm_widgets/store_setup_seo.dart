      ...
      body: FixedBottom(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Text('Store SEO setup', style: theme.textTheme.titleLarge),
              ...
              Text('Facebook Setup', style: theme.textTheme.titleLarge),
              const SizedBox(height: 20),
              ...
              const SizedBox(height: 40),
              Text('Twitter Setup', style: theme.textTheme.titleLarge),
              const SizedBox(height: 20),
