...
class _VariantFormState extends State<VariantForm> {
  ...
  Widget buildFormExpend(ThemeData theme) {
    return Column(
      ...
      children: [
        ListTile(
          title: Text('Enable', style: theme.textTheme.bodyMedium),
        ...
        ListTile(
          title: Text('Downloadable', style: theme.textTheme.bodyMedium),
          contentPadding: EdgeInsets.zero,
          leading: CupertinoSwitch(
            value: _download,
            onChanged: (_) => setState(() {
        ...
        const Divider(height: 1, thickness: 1),
        ListTile(
          title: Text('Virtual', style: theme.textTheme.bodyMedium),
          contentPadding: EdgeInsets.zero,
          leading: CupertinoSwitch(
            value: _virtual,
            onChanged: (_) => setState(() {
        ...
        const Divider(height: 1, thickness: 1),
        ListTile(
          title: Text('Manage Stock', style: theme.textTheme.bodyMedium),
          contentPadding: EdgeInsets.zero,
          leading: CupertinoSwitch(
            value: _managerStock,
            onChanged: (_) => setState(() {
